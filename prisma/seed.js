  ...
  const brands = await prisma.$transaction([
    prisma.brand.create({
      data: {
        ...
        description: 'Patagonia, Inc. is an American retailer of outdoor recreation clothing, equipment, and food.  It was founded by Yvon Chouinard in 1973 and is based in Ventura, California.  Patagonia operates stores in over ten countries, and factories in 16 countries.',
        clothingTypes: str(['Shirt', 'Jacket', 'T-Shirt']),
        knownFor: str(['Ethical production', 'Low water usage', 'Recyclability']),
    ...
    prisma.brand.create({
      data: {
        ...
        description: 'This brand focuses on timeless designs and durable, natural fabrics.  They also have a strong emphasis on circularity, offering take-back programs for old garments and promoting recycling.' ,
    ...
    prisma.brand.create({
      data: {
        ...
        description: 'This brand is know for its radical transparency sharing details about its supply chain and manufacturing processes.  Thye prioritize ethical production and offer a range of wardrobe staples made with sustainable materials.',
