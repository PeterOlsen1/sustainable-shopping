...
import { getClothingById, updateClothingItem, getBrands } from "@/actions/db/queries";
        ...
        <div className="w-full h-full flex flex-col items-center justify-center p-8">
            <div className="w-full max-w-2xl">
                <div className="mb-6">
                    ...
                    <h1 className="text-4xl font-bold text-center">Update Clothing Item</h1>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                    ...
                    {message && (
                        <div className={`mt-4 p-3 rounded-md text-center ${
                            message.includes("Error") || message.includes("not found") || message.includes("No item")
