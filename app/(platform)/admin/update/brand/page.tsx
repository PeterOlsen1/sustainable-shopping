        ...
        <div className="w-full h-full flex flex-col items-start p-8">
            <div className="w-full max-w-6xl mx-auto">
                <div className="mb-6">
                    ...
                    <p className="text-gray-600 text-center">Select a brand to update its information</p>
                </div>
                                ...
                                <div className="flex flex-col h-full">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <div className="flex items-center mb-2">
                                            ...
                                            <span className="ml-1 text-gray-600">{Number(brand.rating).toFixed(1)}</span>
                                        </div>
                                        <a 
                                    ...
                                    {/* Clothing Types */}
                                    <div className="mb-4">
                                        <h4 className="text-sm font-medium text-gray-700 mb-2">Clothing Types:</h4>
                                    ...
                                    {/* Known For */}
                                    <div className="mb-4">
                                        <h4 className="text-sm font-medium text-gray-700 mb-2">Known For:</h4>
                                        <div className="flex flex-wrap gap-1">
                ...
                {brands.length > 0 && (
                    <div className="mt-8 text-center text-gray-600">
                        <p>Showing {brands.length} brand{brands.length !== 1 ? 's' : ''}</p>
                    </div>
                )}
            </div>
        </div>
