...
export default function AdminPage() {
    ...
    const handleClothingSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await addClothingItem(clothingFormData);

            setClothingMessage("Clothing item added successfully!");
            setClothingFormData({ type: "", material: "", price: "", brandId: "", imageURL: "" });
        } catch (error) {
    ...
    const handleBrandSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setBrandFormData({ name: "", website: "", description: "", clothingTypes: "", knownFor: "", rating: "", imageURL: "" });
        } catch (error) {
    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center p-8">
            ...
            <div className="flex flex-col lg:flex-row gap-8 w-full max-w-6xl">
                ...
                {/* Clothing Form */}
                <div className="w-full lg:w-1/2 bg-white rounded-lg shadow-md p-6">
                    <h2 className="text-2xl font-semibold mb-6 text-center">Add New Clothing Item</h2>
                    ...
                    <form onSubmit={handleClothingSubmit} className="space-y-4">
                        ...
                        {/* Image URL Field */}
                        <div>
                            <label htmlFor="clothingImageURL" className="block text-sm font-medium text-gray-700 mb-1">
                                Image URL *
                            </label>
                            <input
                                type="url"
            ...
            <div className="flex gap-8">
                <Link href="/admin/update/item" className="mt-4 inline-block text-blue-600 hover:underline">
                    Update Clothing Items
                </Link>
                <Link href="/admin/update/brand" className="mt-4 inline-block text-blue-600 hover:underline">
